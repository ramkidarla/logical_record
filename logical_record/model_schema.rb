...
module LogicalRecord
  module ModelSchema
    ...
    module ClassMethods
      ...
      # inheritance hierarchy descending directly from LogicalRecord::Base. So if the hierarchy
      # looks like: Reply < Message < LogicalRecord::Base, then Message is used
      ...
      #
      #   class Invoice < LogicalRecord::Base
      #     class Lineitem < LogicalRecord::Base
      #     end
      #   end
      #
      #   file                  class               table_name
      ...
      #
      #   class Mouse < LogicalRecord::Base
      ...
      # the documentation for LogicalRecord::Base#table_name.
      ...
      # values, eg:
      #
      #  class CreateJobLevels < LogicalRecord::Migration
      #    def up
      ...
      def compute_table_name
        ...
        if self == base
          ...
          if parent < LogicalRecord::Base && !parent.abstract_class?
