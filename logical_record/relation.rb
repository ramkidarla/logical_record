...
module LogicalRecord
  ...
  class Relation
    ...
    def insert(values, record = nil)
      ...
      conn.record = record
      conn.insert(primary_key_value, values, 'SQL', binds) 
    end
    ...
    # {Active Record Query Interface guide}[http://edgeguides.rubyonrails.org/logical_record_querying.html#running-explain].
    def explain
    ...
    def exec_queries
      ...
      if default_scoped.equal?(self)
        ...
        preload.each do |associations|
          LogicalRecord::Associations::Preloader.new(@records, associations).run
        end
    ...
    def update_all(updates, conditions = nil, options = {})
      ...
      if conditions || options.present?
        ...
        to_a.each {|object| 
          ...
          raise LogicalRecord::WsRecordInvalid.new(object) unless flag
        }.tap { reset }
    ...
    #   Conditions section in the introduction to LogicalRecord::Base for
    #   more information.
    #
    # ==== Examples
    #
    ...
    # less efficient than LogicalRecord#delete but allows cleanup methods and other actions to be run.
    #
    ...
    def delete_all(conditions = nil)
      raise LogicalRecordError.new("delete_all doesn't support limit scope") if self.limit_value
      ...
      if conditions
        ...
        to_a.each do |object|
          begin
            ...
            @klass.connection.delete(object.id, 'SQL', bind_values) 
