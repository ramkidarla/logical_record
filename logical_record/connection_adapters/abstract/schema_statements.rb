    ...
    module SchemaStatements
      ...
      def change_table(table_name, options = {})
        if supports_bulk_alter? && options[:bulk]
          recorder = LogicalRecord::Migration::CommandRecorder.new(self)
      ...
      def dump_schema_information #:nodoc:
        sm_table = LogicalRecord::Migrator.schema_migrations_table_name
      ...
      def assume_migrated_upto_version(version, migrations_paths = LogicalRecord::Migrator.migrations_paths)
        migrations_paths = Array.wrap(migrations_paths)
        version = version.to_i
        sm_table = quote_table_name(LogicalRecord::Migrator.schema_migrations_table_name)
