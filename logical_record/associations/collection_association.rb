    ...
    class CollectionAssociation < Association #:nodoc:
      ...
      def ids_reader
        if loaded? || options[:finder_sql]
          ...
          if including.any?
            join_dependency = LogicalRecord::Associations::JoinDependency.new(reflection.klass, including, [])
      ...
      private
        ...
        def create_record(attributes, options, raise = false, &block)
          unless owner.persisted?
            raise LogicalRecord::RecordNotSaved, "You cannot call create unless the parent is saved"
          end
        ...
        def include_in_memory?(record)
          if reflection.is_a?(LogicalRecord::Reflection::ThroughReflection)
