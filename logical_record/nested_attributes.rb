...
module LogicalRecord
  module NestedAttributes #:nodoc:
    class TooManyRecords < LogicalRecordError
    end
    ...
    #
    #   class Member < LogicalRecord::Base
    #     has_one :avatar
    ...
    # by the parents save method. See LogicalRecord::AutosaveAssociation.
    #
    ...
    # Returns LogicalRecord::AutosaveAssociation::marked_for_destruction? It's
