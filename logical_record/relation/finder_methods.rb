...
module LogicalRecord
  module FinderMethods
    ...
    # Same as +first+ but raises <tt>LogicalRecord::RecordNotFound</tt> if no record
    ...
    # Same as +last+ but raises <tt>LogicalRecord::RecordNotFound</tt> if no record
    ...
    # see the Conditions section in the introduction to LogicalRecord::Base.
    #
    ...
    #   Person.exists?
    def exists?(id = false)
      id = id.id if LogicalRecord::Base === id
    ...
    def construct_join_dependency_for_association_find
      ...
      LogicalRecord::Associations::JoinDependency.new(@klass, including, [])
    end

    def construct_relation_for_association_calculations
      including = (@eager_load_values + @includes_values).uniq
      join_dependency = LogicalRecord::Associations::JoinDependency.new(@klass, including, arel.froms.first)
