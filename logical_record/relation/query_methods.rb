...
module LogicalRecord
  module QueryMethods
    ...
    # methods appended to it, such as the other methods in LogicalRecord::QueryMethods.
    #
    ...
    def build_joins(manager, joins)
      buckets = joins.group_by do |join|
        ...
        when Hash, Symbol, Array
          'association_join'
        when LogicalRecord::Associations::JoinDependency::JoinAssociation
          'stashed_join'
      ...
      join_dependency = LogicalRecord::Associations::JoinDependency.new(
        @klass,
        association_joins,
        join_list
      )
